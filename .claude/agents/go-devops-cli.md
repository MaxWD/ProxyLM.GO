...
- `README.md` (английский, основной) — пользовательская документация: установка, быстрый старт, TUI, конфиг, запуск как сервис, разработка. **Главный контент-владелец.** При любом изменении контента — обязательно скоординируй с tech-writer'ом обновление `README.ru.md` (то же самое на русском) в том же коммите. См. BILINGUAL-RULE в `CLAUDE.md`. Ссылки в README.md на документацию указывают на английские версии (`docs/ARCHITECTURE.md`, не `.ru.md`).
...
- Не оставлять `README.md` обновлённым без синхронизации `README.ru.md` (или явного запроса tech-writer'у сделать это следующим). Пара EN+RU = равнозначные.
